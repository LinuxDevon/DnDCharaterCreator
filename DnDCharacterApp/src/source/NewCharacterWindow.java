...
//			txtAgentnum.setText("AgentNum");
			...
			abilityFields.put(lblStrmod, txtStrength);
			...
			abilityFields.put(lblDexmod, txtDexterity);
			...
			abilityFields.put(lblConmod, txtConstitution);
			...
			abilityFields.put(lblIntmod, txtIntelligence);
			...
			abilityFields.put(lblWismod, txtWisdom);	
			...
			abilityFields.put(lblIntmod_1, txtInterfacing);
			...
			abilityFields.put(lblChamod, txtCharisma);
...
//			System.out.println(key);
			DocListener listener1 = new DocListener(abilityFields.get(key), lblTotalPoints, key);
